...
A family recipe preservation platform where anyone can create a beautiful, shareable recipe memory page — with photo, recipe details, and a personal story — in under 3 minutes.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "199951820+Bahriyani@users.noreply.github.com"
  git config user.name "Bahriyani"
  ```
